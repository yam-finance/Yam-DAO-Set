...
LANG=C.UTF-8 dapp test --rpc-url "https://fee7372b6e224441b747bf1fde15b2bd.eth.rpc.rivet.cloud/" -v --match test_tm_sushibar_wrap_adapter #test_tm_uniswap_trade_adapter
